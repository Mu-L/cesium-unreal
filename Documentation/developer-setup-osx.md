...
- Install Xcode 16.0+ from https://developer.apple.com/xcode/resources/
- For best JPEG-decoding performance, you must have [nasm](https://www.nasm.us/) installed so that CMake can find it. Everything will work fine without it, just slower.
- Install the minimum supported version of Unreal Engine (version 5.6 as of this writing) from https://www.unrealengine.com/en-US/download

These instructions are intended for Unreal Engine 5.6. The process is similar for newer versions of Unreal Engine. Supported Xcode versions are specified in `/Users/Shared/Epic Games/UE_5.6/Engine/Config/Apple/Apple_SDK.json`.
...
```
export UNREAL_ENGINE_ROOT='/Users/Shared/Epic Games/UE_5.6'
...
```
cd ~/dev/cesium-unreal-samples
"/Users/Shared/Epic Games/UE_5.6/Engine/Build/BatchFiles/Mac/GenerateProjectFiles.sh" -game -project="$PWD/CesiumForUnrealSamples.uproject"
```
...
It probably means Unreal doesn't like your Xcode version. Be sure that a supported version of Xcode is installed. Supported Xcode versions are specified in `/Users/Shared/Epic Games/UE_5.6/Engine/Config/Apple/Apple_SDK.json`.
